(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@akveo/ng2-completer'), require('rxjs'), require('lodash'), require('rxjs/operators'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ng2-smart-table', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@akveo/ng2-completer', 'rxjs', 'lodash', 'rxjs/operators', '@angular/common/http'], factory) :
